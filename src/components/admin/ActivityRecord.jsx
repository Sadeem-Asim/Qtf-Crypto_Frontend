...
const ActivityRecord = (props) => {
  ...
  return (
    <tr
      className={
        configured_by === "not configured" ? "active-row" : "active-border"
      }
    >
      <div className="td-bg"> </div>
      <td>
        <div className="td-bg">{id}</div>
      </td>
      {/*<td>
      ...
      <td>
        <div className="td-bg">
          <span className="text-green">{profit > 0 ? profit : 0}</span>
        </div>
      </td>
      <td>
        <div className="td-bg">
          <span className="text-red">{profit < 0 ? Math.abs(profit) : 0}</span>
        </div>
      </td>
      <td>
        <div className="td-bg">
          {tab === "open" && (
            <div>
              <Form.Check
                ...
                onChange={() => {
                  if (isActive)
                    stopBot({ id: _id, exchange: exchange, user_id });
