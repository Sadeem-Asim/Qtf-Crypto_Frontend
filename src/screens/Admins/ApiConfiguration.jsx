...
const ApiConfiguration = () => {
  ...
  const onChangeHandler = (event, exchange) => {
    ...
    setApiKeys((prevState) => ({
      ...prevState,
      [exchange]: { ...prevState[exchange], [name]: value },
    }));
  };
            ...
            <div className="binance chain-api-main">
              ...
              <Form onSubmit={onSubmitHandler}>
                      ...
                      <div className="custom-box">
                        <div className="flex-center">
                          ...
                          <div className="input-with-icon mt-3">
                            ...
                            />
                            <div className="inner-icon" title="copy">
                ...
                <Row className="offset-md-4 mt-4">
                  <Col md={6}>
                    <button
                      className="custom-btn primary-btn mt-2 w-100"
                      disabled={isLoading}
                    >
